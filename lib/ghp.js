...
function fill(templateFile, model, encoding) {
    ...
    return template(model, [new IncludeHelper(model, encoding)].concat(helpers));
}
...
// Class: IncludeHelper
function IncludeHelper(model, encoding) {
    this.model = model;
    this.encoding = encoding;
}

IncludeHelper.prototype.include = function(templateFile) {
    return fill(templateFile, this.model, this.encoding);
}
